...
def cluster_posts_with_pca(all_posts, tracked_users, n_clusters=4, max_features=100, random_state=42):
    ...
    # Sample non-tracked data and separate tracked data
